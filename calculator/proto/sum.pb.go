...
type SumRequest struct {
	...
	Number_1 uint32 `protobuf:"varint,1,opt,name=number_1,json=number1,proto3" json:"number_1,omitempty"`
	Number_2 uint32 `protobuf:"varint,2,opt,name=number_2,json=number2,proto3" json:"number_2,omitempty"`
}
...
func (x *SumRequest) GetNumber_1() uint32 {
	if x != nil {
		return x.Number_1
	}
	return 0
...
func (x *SumRequest) GetNumber_2() uint32 {
	if x != nil {
		return x.Number_2
	}
	return 0
...
func (x *SumResponse) GetSum() uint32 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_sum_proto_rawDesc = []byte{
	...
	,
